...
function Greetings({ name }) {
    ...
    */
    return (
        <div>
            {name ? <p>Seja bem vindo, {name}</p> : <p>Escreva um nome válido para inciar</p>}
        </div>
    )
}
...
function Counter() {
    ...
    return (
        ...
        <div>
            ...
            <p>O botao foi clicado {count} vez</p>
        </div>
    )
}
...
const TaskList = ({ tasks }) => {
    ...
    if (tasks.length === 0) return <p>Não há tarefas a mostrar!</p>
